...
public class ClassicGameProperties {
    ...
    @PostConstruct public void validate() {
        if (questionCount < 1 || questionCount > 100 || revivalCount < 0 || revivalCount >= questionCount || !Double.isFinite(easyWeight) || easyWeight < 0 || easyWeight > 1) throw new IllegalStateException("经典模式基础配置非法");
